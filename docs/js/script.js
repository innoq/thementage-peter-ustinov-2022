$(document).ready(function documentReady() {
  ...
  if(window.location.href.indexOf("handbook") > -1 || window.location.href.indexOf("mentor") > -1 || window.location.href.indexOf("raspberryPi") > -1 || window.location.href.indexOf("useful") > -1) {
       tocInit();
    }
  else {
